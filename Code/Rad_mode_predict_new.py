...
def main() -> None:
    ...
    input_dir: Path = root_dir / "Files" / "Linear_Relation_new"
    ...
    save_path = root_dir / "Figure" / "Rad_mode_predict_new.png"
    ...
    # file path
    output_path: Path = root_dir / "Files" / "Linear_Relation_new"
